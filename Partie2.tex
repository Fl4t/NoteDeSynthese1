\chapter{Script de comparaison de base de données}
...
l'entreprise dans l'application qu'ils développaient, cela dit on m'a confié une
tâche annexe qui est la comparaison des bases de données.
