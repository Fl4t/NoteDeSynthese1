...
commencer. \bsc{M.~Dubourg} m'a mis sur la voie en me disant d'utiliser des
...
énormément mon avancé pour pas grand-chose. \bsc{M.~Dubourg} constatant que je
...
totalement tout le script. \bsc{M.~Dubourg} m'a rassuré sur le fait que
...
requêtes SQL, \bsc{M.~Dubourg} m'a présenté un outil nommé \og Smarty \fg{} qui
...
% subsection Affichage du résultat (end)%}}}
% section Le script PHP (end)%}}}
% chapter Script de comparaison (end)
